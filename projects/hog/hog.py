...
def announce_highest(who, previous_high=0, previous_score=0):
    ...
    def say(score0, score1):
        ...
        increase_score = current_score - previous_score
        if increase_score > previous_high:
            print("{} point(s)! That's the biggest gain yet for Player {}".format(increase_score, who))
        return announce_highest(who, max(increase_score, previous_high), current_score)
    return say
    # END PROBLEM 7
...
def max_scoring_num_rolls(dice=six_sided, num_samples=1000):
    ...
    max_num_rolls, max_score = 1, 1
    for num_rolls in range(1, 11):
        current_score = average(num_rolls, dice)
        if current_score > max_score:
            max_num_rolls, max_score = num_rolls, current_score
