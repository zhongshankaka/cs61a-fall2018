...
def group_by_centroid(restaurants, centroids):
    ...
    # BEGIN Question 4
    "*** YOUR CODE HERE ***"
    rc_pairs = [[find_closest(restaurant_location(r), centroids), r] for r in restaurants]
    return group_by_first(rc_pairs)
    # END Question 4
...
def find_centroid(cluster):
    ...
    # BEGIN Question 5
    "*** YOUR CODE HERE ***"
    return [mean(l) for l in zip(*[restaurant_location(r) for r in cluster])]
    # END Question 5
